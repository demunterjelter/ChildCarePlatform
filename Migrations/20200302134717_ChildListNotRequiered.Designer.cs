...
namespace ChildCarePlatform.Migrations
{
    ...
    [Migration("20200302134717_ChildListNotRequiered")]
    partial class ChildListNotRequiered
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChildCarePlatform.Models.Child", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ChildCarePlatform.Models.Child", b =>
                {
                    b.HasOne("ChildCarePlatform.Models.Customer")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("ChildCarePlatform.Models.Customer", b =>
                {
                    b.HasOne("ChildCarePlatform.Models.BabySitter")
                        .WithMany("Customers")
